...
<div class="panel-page">
  ...
  <vs-table multiple v-model="selected" pagination max-items="10" :data="users">
    ...
    <template slot="thead">
      <vs-th sort-key="thumb">Thumb</vs-th> 
      <vs-th sort-key="ad">Ad</vs-th> 
    ...
    <template slot-scope="{data}">
      <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
        ...
        <vs-td :data="data[indextr].trumb">
          <img class="adimage" src="@/assets/images/name.jpeg" alt="img">
        </vs-td>

        <vs-td :data="data[indextr].ad">
          <div class="flex align-center account-name">
            <div class="name-user accname">{{ data[indextr].name}}</div>
            <div class="iconsad">
              ...
              <vs-icon size="small" icon-pack="feather" icon="icon-message-circle" color="rgb(115,103,240)" />
              (0)
            </div>
            <div class="name-user dataad">Ad ID: {{ data[indextr].adid}}</div>
            <div class="name-user dataad">Creative ID: {{ data[indextr].creativeid}}</div>
            <div class="name-user dataad">Adset: {{ data[indextr].adset}}</div>
            <div class="name-user dataad">Campaign: {{ data[indextr].campaign}}</div>
