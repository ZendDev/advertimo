  ...
  <div class="parentx">
    ...
    <vs-sidebar
      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <!-- Header -->
        <div class="header-sidebar flex justify-between" slot="header">
          ...
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
            ...
            <template v-else>
                <img class="logo-advertimo-mobile" src="@/assets/images/mobile-logo.png" alt="advertimo">
            </template>      
          </router-link>
          <!-- /Logo -->
...
import DarkToggler from '@/layouts/components/navbar/components/DarkToggler.vue'
